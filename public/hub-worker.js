...
// This entry need to be wrapped in an IIFE because it need to be isolated against other modules in the chunk.
    (() => {
        ...
        function on_msg_newChannel(port, msg) {
            ...
            port.postMessage( { error:null, port:channel.port2, reqId: msg.reqId },
                [ channel.port2 ] )
        ...
        function on_chan_get(port, msg) {
            // local only!
            let payload = self.state.retained.get(msg.topic);
        ...
        function on_chan_unsubscribe(port, msg) {
            ...
            if (newList.length > 0) {
                ...
                if (self.state.paho === null || self.state.localSubTopics.has(msg.topic) || !self.state.connected) {
